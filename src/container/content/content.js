...
const ContentDashboard = () => {
  const detailsUser = useContext(MapContext)
  const detailsUserContent = Object.values(detailsUser)
  console.log(detailsUser, "detailsUser")
  console.log(detailsUserContent, "detailsUserContent")
    ...
    <div className="dashboardContent">
      ...
      <div className="site-layout-background" style={{ padding: 24, textAlign: 'center' }}>
        ...
        <div className="content"   >
          ...
          <Mapp detailsUser={ detailsUserContent }  />
        </div>
      </div>
    </div>
  )
